...
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  ('2022-09-06 01:40:52', '', 'login', '');
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  ('2022-09-08 03:55:51', '', 'login', '');
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
...
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  ('2022-09-21 08:53:34', '', 'login', '');
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  ('2022-09-27 00:20:23', '', 'login', '');
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  ('2022-10-03 08:25:35', '', 'login', '');
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  ('2022-10-04 23:59:43', '', 'login', '');
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  ('2022-10-10 10:57:06', '', 'login', '');
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
...
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  ('2022-10-19 05:52:33', '', 'login', '');
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  ('2022-10-19 08:59:48', '', 'login', '');
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
  (
...
VALUES
  (
    'zM9Ra8iKbKH56UM4oz-Dl3_we5tGMs_-',
    1666438648,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{\"warning\":[\"Sucedió algun error!\",\"Sucedió algun error!\",\"Sucedió algun error!\",\"Sucedió algun error!\"],\"success\":[\"Backup de la BBDD realizado correctamente\"]},\"passport\":{\"user\":1}}'
  );
