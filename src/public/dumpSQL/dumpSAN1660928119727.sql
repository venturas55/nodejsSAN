...
) ENGINE = InnoDB AUTO_INCREMENT = 596 DEFAULT CHARSET = latin1 COMMENT = 'tabla de mantenimiento del balizamiento';
...
) ENGINE = InnoDB AUTO_INCREMENT = 102 DEFAULT CHARSET = latin1 COMMENT = 'tabla de observaciones del balizamiento';
...
VALUES
  (
    ...
    'user1',
    'INSERT documento',
    '4de48323-109a-4328-b02b-e9cf276206d4.pdf'
  );
INSERT INTO
  `logs` (`fecha`, `usuario`, `accion`, `observacion`)
VALUES
...
VALUES
  (
    'SogFfR6gReXUy0Tk6FkKtRvH4BN6G4Rp',
    1661014520,
...
VALUES
  (
    'sYPwvTwAa2wGzqDFYVXvQebcsSoCzFZM',
    1660896143,
    '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"flash\":{},\"passport\":{\"user\":1}}'
  );
